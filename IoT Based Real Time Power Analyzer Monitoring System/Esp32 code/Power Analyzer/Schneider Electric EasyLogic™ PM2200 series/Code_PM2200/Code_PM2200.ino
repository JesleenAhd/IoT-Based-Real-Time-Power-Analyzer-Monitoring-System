...
#define NUM_SLAVES 1
const uint8_t SLAVE_IDS[NUM_SLAVES] = {1 };
#define FUNCTION_CODE 0x03  // Read Input Registers
...
int16_t modbusRegisters[] = {
  ...
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0C83, 0x0C87, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0C93, 0x0C97, 0x0000,
